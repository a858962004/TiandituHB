package com.gangbeng.tiandituhb.provider;
...
import com.gangbeng.tiandituhb.db.CountyChanged;

import org.litepal.crud.DataSupport;

public class WidgetListviewContentProvider extends ContentProvider {

    private static final String authority = "com.gangbeng.tiandituhb.provider.WidgetListviewContentProvider";
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        SQLiteDatabase db = SQLiteDatabase.openOrCreateDatabase("/data/data/com.gangbeng.tiandituhb/databases/dong_weather.db", null);
        Cursor cursor = null;
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case COUNTYCHANGED_DIR:
                return "vnd.android.cursor.dir/vnd.com.gangbeng.tiandituhb.provider.WidgetListviewContentProvider.CountyChanged";
            case COUNTYCHANGED_ITEM:
                return "vnd.android.cursor.item/vnd.com.gangbeng.tiandituhb.provider.WidgetListviewContentProvider.CountyChanged";
            default:
                break;
        }
        return null;

...
import com.gangbeng.tiandituhb.model.GetUserModel;
...
public class GetUserPresenter implements BasePresenter, OnCallBack {
    private BaseView view;
    private BaseModel model;

    public GetUserPresenter(BaseView view) {
        this.view = view;
    ...
    public void setRequest(Map<String, Object> parameter) {
        view.showLoadingDialog("请稍后", "正在获取用户信息", false);
